...
<Steps>
  ...
  <Step title="Apply rich text formatting">
    Use the formatting toolbar to add bold, italic, subscript, or superscript text to any term or definition. Useful for scientific notation, mathematical expressions, or emphasizing key vocabulary.
  </Step>
