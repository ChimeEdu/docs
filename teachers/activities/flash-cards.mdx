...
<Steps>
  ...
  <Step title="Add your cards">
    Add a deck first, then click **Add Card** for each item in it. Every card has a **Front Content** field and a **Back Content** field. Add as many cards as your deck requires.
  </Step>
